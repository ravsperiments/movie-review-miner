...
from review_aggregator.db.critic_queries import get_critics
...
async def orchestrate_fetch_links():
    ...
    for critic in critics:
        ...
        # The naming convention is 'review_aggregator.critics.<domain_prefix>'.
        # For example, 'baradwajrangan.wordpress.com' becomes 'baradwajrangan'.
        module_name = f"review_aggregator.critics.{domain.split('.')[0]}"
